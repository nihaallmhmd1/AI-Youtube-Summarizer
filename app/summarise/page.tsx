  ...
  return (
    <DashboardContainer>
      <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="relative bg-[#111827] dark:bg-black rounded-[3.5rem] p-10 md:p-16 text-white overflow-hidden group shadow-[0_40px_100px_-20px_rgba(0,0,0,0.15)] dark:shadow-emerald-900/20 max-w-7xl mx-auto border border-white/10 w-full mb-8">
          {/* Subtle Background Glow */}
          <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-500/20 rounded-full blur-[100px] -mr-48 -mt-48 group-hover:scale-125 transition-transform duration-1000 pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-teal-500/10 rounded-full blur-[80px] -ml-32 -mb-32 pointer-events-none" />

          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-12 w-full">
            <div className="max-w-xl">
              <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest mb-6 border border-white/10 shadow-inner">
                <Sparkles size={12} className="text-amber-400" />
                <span>AI Insights Engine</span>
              </div>
              <h1 className={`text-4xl md:text-5xl lg:text-7xl font-black text-white mb-4 tracking-tighter uppercase ${isNonLatin ? 'normal-case italic-none' : 'italic'} leading-[0.9]`}>
                YouTube <br />
                <span className="text-emerald-400">Summariser.</span>
              </h1>
              <p className="text-slate-300 font-medium tracking-tight text-lg leading-relaxed max-w-lg">Get the core insights from any video instantly.</p>
            </div>

            <form onSubmit={handleGenerate} className="relative z-10 flex flex-col sm:flex-row gap-4 w-full lg:w-auto lg:min-w-[500px]">
              <div className="flex-1 relative group/input">
                <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none transition-transform group-focus-within/input:text-emerald-400">
                  <Youtube className="text-slate-400 w-5 h-5 group-focus-within/input:text-emerald-400 transition-colors" />
                </div>
                <input
                  type="text"
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all placeholder:text-slate-400 text-sm font-bold text-white shadow-inner h-[56px] backdrop-blur-xl"
                />
              </div>
              <button
                type="submit"
                disabled={loading || !url}
                className="bg-white hover:bg-slate-50 text-[#0a0a0a] font-black px-8 rounded-2xl shadow-xl transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 uppercase tracking-widest text-[10px] whitespace-nowrap h-[56px] outline-none"
              >
                {loading ? (
        ...
        {previewInfo && !result && (
          <div className="flex justify-center animate-in fade-in slide-in-from-top-4 duration-500 mt-8 mb-6">
            <div className="bg-white dark:bg-[#191e16]/80 p-5 rounded-[2.5rem] border border-emerald-100 dark:border-white/10 flex gap-6 items-center backdrop-blur-3xl shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] dark:shadow-none w-full max-w-3xl relative overflow-hidden group">
              ...
              <div className="relative w-36 md:w-48 aspect-video rounded-2xl overflow-hidden shadow-inner shrink-0 bg-black/5 group-hover:scale-105 transition-transform duration-700 z-10">
                <Image src={`https://img.youtube.com/vi/${currentVideoId}/maxresdefault.jpg`} unoptimized fill className="object-cover" alt="Video Preview" />
              </div>
        ...
        {result && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 animate-in fade-in slide-in-from-top-4 duration-1000 w-full max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-4 space-y-10">
              {/* Video Info Card */}
              <div className="bg-white dark:bg-[#191e16]/80 flex flex-col rounded-[3.5rem] border border-emerald-100 dark:border-white/10 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.15)] dark:shadow-none backdrop-blur-3xl overflow-hidden relative group/sidebar">

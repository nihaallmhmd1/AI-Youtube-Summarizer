...
function LoginContent() {
  ...
  const features = [
    ...
    { icon: MessageSquare, title: 'IA Agent Chat', desc: 'Ask specific questions directly to the video.' },
    ...
    <div className="min-h-screen bg-white dark:bg-[#020202] text-slate-900 dark:text-white font-sans selection:bg-emerald-500/30">
      ...
      <nav className="relative z-50 flex items-center justify-between px-8 md:px-16 py-8">
        ...
        <div className="flex items-center gap-6">
          <button 
            ...
            className="text-xs font-black uppercase tracking-widest text-[#646e5a] dark:text-slate-400 hover:text-emerald-500 transition-colors hidden sm:block"
          >
            Login
          </button>
          <button 
            onClick={() => setView('signup')}
            className="bg-[#111827] dark:bg-white text-white dark:text-black px-6 py-3 rounded-xl text-xs font-black uppercase tracking-widest shadow-xl hover:scale-105 transition-all"
          >
            Get Started
          </button>
        </div>
      ...
      <main className="relative z-10 px-8 md:px-16 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center max-w-7xl mx-auto">
        ...
        <div className="space-y-10 order-2 lg:order-1">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 rounded-full text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 mb-6">
          ...
          <div className="pt-8 flex items-center gap-10 opacity-40">
            <div className="flex flex-col gap-2">
              <span className="text-[10px] font-black uppercase tracking-widest">Trusted by</span>
          ...
          >
            ...
            <div className="bg-white dark:bg-[#191e16]/80 backdrop-blur-3xl border border-emerald-100 dark:border-white/10 rounded-[3.5rem] p-10 md:p-12 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.15)] dark:shadow-none relative z-10">
              ...
              <button
                ...
                className="w-full bg-white dark:bg-white/5 border border-emerald-100 dark:border-white/10 py-4 px-6 rounded-2xl flex items-center justify-center gap-4 text-sm font-bold shadow-sm hover:shadow-md hover:bg-slate-50 dark:hover:bg-white/10 transition-all disabled:opacity-50 group"
              >
                {googleLoading ? (
              ...
              <form onSubmit={view === 'login' ? handleLogin : handleSignUp} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#111827] dark:bg-emerald-500 text-white dark:text-[#0a0a0a] font-black py-4 rounded-2xl shadow-xl shadow-emerald-500/20 transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-50 flex items-center justify-center gap-3 uppercase tracking-[0.2em] text-[10px] h-[56px]"
                >
                  {loading ? (
              ...
              <div className="mt-8 text-center space-y-4">
                <button 
                  ...
                  className="text-[10px] font-black uppercase tracking-widest text-[#646e5a] dark:text-slate-400 hover:text-emerald-500 transition-colors"
                >
